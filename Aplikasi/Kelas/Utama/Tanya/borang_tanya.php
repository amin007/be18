...
#---------------------------------------------------------------------------------------------------#
	...
	{
		$data = array('202','301','302','303','304','305','306','308','309','310','311','312',
...
#---------------------------------------------------------------------------------------------------#
	private function soalanGajiSijil()
	{
		$sql = '
		SELECT "01-PEMILIK" STAF, "L01" `JANTINA`,`F4901` MSIA,`F5001` XMSIA,`F1401` JUM,"" GAJI, "" SUB,"Pascasiswazah" SIJIL, "06" K,`F1506` L, `F1606` P FROM $myTable UNION
		SELECT "02-KELUARGA" STAF, "L02", `F4902` MSIA,`F5002` XMSIA,`F1402` JUM,"" GAJI, "" SUB,"Bacelor Akademik", "41",`F1541` L, `F1641` P FROM $myTable UNION
		SELECT "03-PENGURUS" STAF, "L12", `F4912` MSIA,`F5012` XMSIA,`F1412` JUM,`F1812` GAJI,`F5112` SUB,"Bacelor Teknikal", "42",`F1542` L, `F1642` P FROM $myTable UNION
		SELECT "04-PRO" STAF, "L13", `F4913` MSIA,`F5013` XMSIA,`F1413` JUM,`F1813` GAJI,`F5113` SUB,"Diploma Akademik", "43",`F1543` L, `F1643` P FROM $myTable UNION
		SELECT "05-PENYELIDIK" STAF, "L04", `F4904` MSIA,`F5004` XMSIA,`F1404` JUM,`F1804` GAJI,`F5104` SUB,"Diploma Teknikal TVET", "44",`F1544` L, `F1644` P FROM $myTable UNION
		SELECT "06-JURUTEKNIK" STAF, "L05", `F4905` MSIA,`F5005` XMSIA,`F1405` JUM,`F1805` GAJI,`F5105` SUB,"STPM", "03",`F1503` L, `F1603` P FROM $myTable UNION
		SELECT "07-KERANI" STAF, "L14", `F4914` MSIA,`F5014` XMSIA,`F1414` JUM,`F1814` GAJI,`F5114` SUB,"Sijil Akademik", "45",`F1545` L, `F1645` P FROM $myTable UNION
		SELECT "08-JUALAN" STAF, "L15", `F4915` MSIA,`F5015` XMSIA,`F1415` JUM,`F1815` GAJI,`F5115` SUB,"Sijil SKM 3", "46",`F1546` L, `F1646` P FROM $myTable UNION
		SELECT "09-KEMAHIRAN" STAF, "L16", `F4916` MSIA,`F5016` XMSIA,`F1416` JUM,`F1816` GAJI,`F5116` SUB,"Sijil SKM 1&2", "47",`F1547` L, `F1647` P FROM $myTable UNION
		SELECT "10-MESIN" STAF, "L06", `F4906` MSIA,`F5006` XMSIA,`F1406` JUM,`F1806` GAJI,`F5106` SUB,"Sijil Kemahiran lain", "48",`F1548` L, `F1648` P FROM $myTable UNION
		SELECT "11-ASAS" STAF, "L06", `F4906` MSIA,`F5006` XMSIA,`F1406` JUM,`F1806` GAJI,`F5106` SUB,"SPM", "04",`F1504` L, `F1604` P FROM $myTable UNION
		SELECT "12-JUM-TETAP" STAF, "L17", `F4917` MSIA,`F5017` XMSIA,`F1417` JUM,`F1817` GAJI,`F5117` SUB,"Bawah SPM", "05",`F1505` L, `F1605` P FROM $myTable UNION
		SELECT "13-JUM-SAM" STAF, "L11", `F4911` MSIA,`F5011` XMSIA,`F1411` JUM,`F1811` GAJI,`F5111` SUB,"JUMLAH", "09",`F1509` L, `F1609` P FROM $myTable UNION
		SELECT "14-JUMLAH" STAF, "L19", `F4919` MSIA,`F5019` XMSIA,`F1419` JUM,`F1819` GAJI,`F5119` SUB,"","","","" FROM $myTable UNION

		SELECT "01-PEMILIK" STAF, "P21", `F4921` MSIA,`F5021` XMSIA,`F1421` JUM,"" GAJI, "" SUB,"","","","" FROM $myTable UNION
		SELECT "02-KELUARGA" STAF, "P22", `F4922` MSIA,`F5022` XMSIA,`F1422` JUM,"" GAJI, "" SUB,"","","","" FROM $myTable UNION
		SELECT "03-PENGURUS" STAF, "P32", `F4932` MSIA,`F5032` XMSIA,`F1432` JUM,`F1832` GAJI,`F5132` SUB,"","","","" FROM $myTable UNION
		SELECT "04-PRO" STAF, "P23", `F4923` MSIA,`F5023` XMSIA,`F1423` JUM,`F1823` GAJI,`F5123` SUB,"","","","" FROM $myTable UNION
		SELECT "05-PENYELIDIK" STAF, "P33", `F4933` MSIA,`F5033` XMSIA,`F1433` JUM,`F1833` GAJI,`F5133` SUB,"","","","" FROM $myTable UNION
		SELECT "06-JURUTEKNIK" STAF, "P24", `F4924` MSIA,`F5024` XMSIA,`F1424` JUM,`F1824` GAJI,`F5124` SUB,"","","","" FROM $myTable UNION
		SELECT "07-KERANI" STAF, "P25", `F4925` MSIA,`F5025` XMSIA,`F1425` JUM,`F1825` GAJI,`F5125` SUB,"","","","" FROM $myTable UNION
		SELECT "08-JUALAN" STAF, "P34", `F4934` MSIA,`F5034` XMSIA,`F1434` JUM,`F1834` GAJI,`F5134` SUB,"","","","" FROM $myTable UNION
		SELECT "09-KEMAHIRAN" STAF, "P35", `F4935` MSIA,`F5035` XMSIA,`F1435` JUM,`F1835` GAJI,`F5135` SUB,"","","","" FROM $myTable UNION
		SELECT "11-ASAS" STAF, "P36", `F4936` MSIA,`F5036` XMSIA,`F1436` JUM,`F1836` GAJI,`F5136` SUB,"","","","" FROM $myTable UNION
		SELECT "12-JUM-TETAP" STAF, "P26", `F4926` MSIA,`F5026` XMSIA,`F1426` JUM,`F1826` GAJI,`F5126` SUB,"","","","" FROM $myTable UNION
		SELECT "13-JUM-SAM" STAF, "P31", `F4931` MSIA,`F5031` XMSIA,`F1431` JUM,`F1831` GAJI,`F5131` SUB,"","","","" FROM $myTable UNION
		SELECT "14-JUMLAH" STAF, "P39", `F4939` MSIA,`F5039` XMSIA,`F1439` JUM,`F1839` GAJI,`F5139` SUB,"","","","" FROM $myTable UNION
		';
		return $sql;
	}
#---------------------------------------------------------------------------------------------------#
